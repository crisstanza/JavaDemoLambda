...
/**
 * Handler compativel com Lambda Function URL / API Gateway HTTP API.
 * <p>
 * O evento chega como um Map contendo, entre outras coisas, o campo "body"
 * (uma String com o JSON enviado pelo cliente). A resposta precisa conter
 * "statusCode" e "body" para o gateway montar a resposta HTTP.
 */
public class LambdaCep implements RequestHandler<Map<String, Object>, Map<String, Object>> {
